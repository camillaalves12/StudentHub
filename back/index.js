...
const pool = new Pool({
  ...
  database: 'studentbd',     // Nome do banco de dados
...
app.post('/students', async (req, res) => {
  const { name, cpf, email, phone, city, course } = req.body; 
  try {
    const result = await pool.query(
      'INSERT INTO students (name, cpf, email, phone, city, course) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *',
      [name, cpf, email, phone, city, course]
    );
